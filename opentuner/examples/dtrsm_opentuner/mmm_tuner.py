...
class GccFlagsTuner(MeasurementInterface):
  ...
  def run(self, desired_result, input, limit):
    ...
    gcc_cmd += 'gcc  -c  {0}  {1}  {2}  -D{3}={4}  dtrsm.c       -o  dstrsm.o && '.format(INC,CFLAGS,LIBS,'TILE_SIZE',cfg['TILE_SIZE'])  
    gcc_cmd += 'gcc  dcm2ccrb.o dccrb2cm.o core_dgemm.o pdgemm.o dgemm.o core_dtrsm.o pdtrsm.o dtrsm.o {0}  {1}  {2}  -D{3}={4}  test_opentuner.c  -o  ./tmp.bin'.format(INC,CFLAGS,LIBS,'TILE_SIZE',cfg['TILE_SIZE'])  
